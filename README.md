...
- Deep sequence learning for UAV trajectory modeling
- Pretrained temporal and transformer-based models
- Anomaly detection and integrity verification
- GPS-independent or GPS-resilient localization
- Lightweight inference for resource-constrained UAV platforms
...
Those are maintained in separate research repositories.
